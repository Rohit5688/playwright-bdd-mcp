...
export class FileWriterService {
    ...
    loadManifest(projectRoot) {
        ...
        if (!fs.existsSync(manifestPath))
            return {};
        try {
            return JSON.parse(FileGuard.readTextFileSafely(manifestPath));
        }
        catch {
            return {};
        }
     ...
     */
    async validateAndWrite(projectRoot, files, stagingService, fileStateService, dryRun = false) {
     ...
     */
    async replaceInFile(projectRoot, filePath, oldString, newString, stagingService, fileStateService, dryRun = false) {

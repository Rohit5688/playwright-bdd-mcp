...
export class SeleniumMigrationService {
     ...
     */
    generateMigrationPrompt(projectRoot, legacyCode, sourceDialect, codebaseContext, memoryPrompt = "") {
...
Existing Pages Discovered: ${codebaseContext?.existingPageObjects?.map((p) => p.path).join(', ') || 'None'}
...
//# sourceMappingURL=SeleniumMigrationService.js.map
...
description: A comprehensive library of 35+ golden prompts for every stage of the test automation lifecycle.
---
...
> [!TIP]
> **Pro Tip**: When using these prompts, always include the phrase **"Follow the TestForge Protocol"** to trigger established POM-first patterns.
